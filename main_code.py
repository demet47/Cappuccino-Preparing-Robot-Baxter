    ...
    while True:
        ...
        try:
            ...
            if((state_counter == 0) & (lower_case.__contains__("hello"))):
                ...
                response_recording = "baxter_greeting.mp3"
                ...
                response_recording = "baxter_sugar_request.mp3"
                __text_to_speech__(baxter_response, response_recording)
                __display_sound__(response_recording)
                state_counter = state_counter + 1
                print("In state: ", state_counter - 1)
                ...
                if(text.__contains__("low sugar")):
                    ...
                    response_recording = "baxter_preparation_initalization_low_milk.mp3"
                    __text_to_speech__(baxter_response, response_recording)
                    __display_sound__(response_recording)
                    state_counter = state_counter + 1
                    print("In state: ", state_counter - 1)
                    ...
                    response_recording = "baxter_preparation_initalization_high_milk.mp3"
                    __text_to_speech__(baxter_response, response_recording)
                    __display_sound__(response_recording)
                    state_counter = state_counter + 1
                    ...
                    response_recording = "baxter_clarification_sugar.mp3"
                    __text_to_speech__(baxter_response, response_recording)
                    __display_sound__(response_recording)
                ...
                response_recording = "baxter_sugar_farewell.mp3"
                __text_to_speech__(baxter_response, response_recording)
                __display_sound__(response_recording)
                print("In state: ", state_counter - 1)
                state_counter = 0
            ...
            response_recording = "non-comprehending_baxter.mp3"
            __text_to_speech__(baxter_response, response_recording)
            __display_sound__(response_recording)
