...
#SAMPLE DATA FORMER
'''
** the file is for creating default trajectories of implied shapes. It is written for learning purposes.
...
#BEWARE: circle trajectory requires smaller t, sinus-like ones require larger t. others not sure but don't variate much.