...
# load test demo
#test_dataset = torch.load('../../../../raw_data/demos_4_8_test/data.pt')
# load predictions
#pred = torch.load('../../../../raw_data/demos_4_8_train/cropped_and_aligned_clipped.pt')



test_dataset = []
with open('./initial_data/salimdemet.csv', newline='') as csvfile:
...
# visualize the demo trajectoriy:
#input(f"Enter to visualize the demo and prediction for {key}, which has the shape {test_data.shape}")
